...
public class SingleLinkedLists extends CommonCodes implements ActionListener {
    ...
    JLabel heading;
    public SingleLinkedLists(String title)
    {
        super(title);
        backButton = backButtonLayout();
        backButton.addActionListener(this);
        add(backButton);
        heading = headingLabelSetter("Single Linked Lists", 310, 10, 400, 50);
        add(heading);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if(event.getSource() == insertAtTailButton){
            new InsertAtTail("Data Structures/Linear Data Structures/Linked Lists/Single Linked Lists/Insert At Tail");
        }
        if(event.getSource() == deleteAtTailButton){
            new DeleteAtTail("Data Structures/Linear Data Structures/Linked Lists/Single Linked Lists/Delete At Tail");
        }
        if(event.getSource() == insertAtHeadButton){
            new InsertAtHead("Data Structures/Linear Data Structures/Linked Lists/Single Linked Lists/Insert At Head");
        }
        if(event.getSource() == deleteAtHeadButton){
            new DeleteAtHead("Data Structures/Linear Data Structures/Linked Lists/Single Linked Lists/Delete At Head");
        }
        if(event.getSource() == insertAtPositionButton){
            new InsertAtPosition("Data Structures/Linear Data Structures/Linked Lists/Single Linked Lists/Insert At Position");
        }
        if(event.getSource() == deleteAtPositionButton){
            new DeleteAtPosition("Data Structures/Linear Data Structures/Linked Lists/Single Linked Lists/Delete At Position");
        }
        dispose();
    }
}
